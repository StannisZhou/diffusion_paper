...
Finally, we check the accuracy of the capacity estimation algorithm employed by CHop.  Take $r_A = 0.02, r_{\tilde{A}} = 0.1$, and $d_A = 0.05$. We can get an analytical formula for the capacities in this case.  We compare these exact values with those estimated using the method outlined in Section \ref{sec:outlinecapacest}, with parameters $
m = 2, n = 4, 
N_p = 100, N_b = 3,
N_s = 1000
$ and a time-step of $1 \times 10^{-6}$.  We obtain $\capac{A}{\tilde{A}}= 0.000637 $, and our method obtained the estimate $ 0.000553 $.  These show good agreement between the truth and our estimates.  
