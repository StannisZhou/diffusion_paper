...
\fbox{\begin{minipage}{\textwidth}
    \includegraphics[width=\textwidth]{results_brownian_motion.pdf}
...
\begin{figure}
\fbox{\begin{minipage}{\textwidth}
    \includegraphics[width=\textwidth]{results_nontrivial.pdf}
