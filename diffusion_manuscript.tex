...
\[\mathcal{E} (h_{A,B}, h_{A,B}) \geq  
   \left( 1 - m - \frac{\varepsilon}{2} \right)^2 \tmop{cap} (A,\tilde{A}) \indicatorf_{m\leq 1-\frac{\varepsilon}{2}} + 
   \left( m- \frac{\varepsilon}{2} \right)^2 \tmop{cap} (B, \tilde{B})\indicatorf_{m\geq \frac{\varepsilon}{2}} 
\]
\end{lemma}
\begin{proof}
...
\[
\int_{\tilde A} \Vert \sigma \nabla h_{A,B}\Vert^2 dx \geq \left(1 - m - \frac{\varepsilon}{2}\right)^2 \capac{A}{\tilde A}\indicatorf_{m\leq 1-\frac{\varepsilon}{2}}
\]
...
\left( 1 - m - \frac{\varepsilon}{2} \right)^2 \capA \indicatorf_{m\leq 1-\frac{\varepsilon}{2}} + 
   \left( m- \frac{\varepsilon}{2} \right)^2 \capB \indicatorf_{m\geq \frac{\varepsilon}{2}} 
\]
